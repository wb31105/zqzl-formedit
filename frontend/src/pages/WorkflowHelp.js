...
function WorkflowHelp() {
  ...
  const validationRules = [
    ...
    { rule: '条件分支双路径', desc: '条件分支节点必须至少有两条出边，建议设置"是/否"标签区分路径' },
        ...
        <section className="help-section">
          ...
          <div className="condition-detail">
            ...
            <div className="principle-diagram">
              ...
              <ol>
                ...
                <li>检查是否配置了<strong>条件表达式</strong>
                  <ul>
                    <li>如果有表达式 → 解析表达式，计算结果（true/false）</li>
                    <li>如果没有表达式 → 查找上一个审批节点的操作结果（批准/拒绝）</li>
                  </ul>
                </li>
                <li>根据判断结果查找对应的出边
                  <ul>
                    <li>结果为 true → 查找标签为"是"/"批准"/"同意"等的连线</li>
                    <li>结果为 false → 查找标签为"否"/"拒绝"/"退回"等的连线</li>
                  </ul>
                </li>
                <li>沿匹配的连线自动流转到下一个节点</li>
              </ol>
            </div>
            ...
            <div className="label-rules">
              <p>系统会自动识别以下标签，不区分大小写：</p>
              <div className="label-groups">
                <div className="label-group">
                  <h4>✅ 批准/通过路径（匹配条件true）</h4>
                  <span className="label-tag">是</span>
                  <span className="label-tag">yes</span>
                  <span className="label-tag">批准</span>
                  <span className="label-tag">同意</span>
                  <span className="label-tag">通过</span>
                  <span className="label-tag">ok</span>
                  <span className="label-tag">true</span>
                </div>
                <div className="label-group">
                  <h4>❌ 拒绝/退回路径（匹配条件false）</h4>
                  <span className="label-tag">否</span>
                  <span className="label-tag">no</span>
                  <span className="label-tag">拒绝</span>
                  <span className="label-tag">退回</span>
                  <span className="label-tag">不通过</span>
                  <span className="label-tag">驳回</span>
                  <span className="label-tag">false</span>
                </div>
              </div>
            </div>
